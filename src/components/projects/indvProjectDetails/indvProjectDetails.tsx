...
const IndvProjectDetails = ({ params }: { params: { id: string } }) => {
    return (
        <>
            <div className="h-[70vh]" style={{ background: `url(${projects[parseInt(params.id) - 1].image})`, backgroundSize: "cover", opacity: .5 }} />
            <section>
            ...
            <div className="bg-ternary p-3 cursor-pointer bg-opacity-80 hover:bg-opacity-100 fixed top-5 left-5">
