...
const Home = () => {
    return (
        <main className="flex">
            <section className="flex bg-[#ffdc80] h-[700px] w-2/3 justify-between relative">
                ...
                <div className="w-[100px] overflow-hidden">
                    <DotTexture length={300}/>
                </div>
            </section>
            <section className="relative flex-1">
                <div className="absolute border-[10px] rounded-[50%] border-solid border-white top-[125.5px] left-[-150px] p-5">
